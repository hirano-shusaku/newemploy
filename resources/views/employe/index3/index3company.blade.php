            ...
            <table class="text-left w-full border-collapse mt-8"> 
                    <tr class="bg-blue-700">
                      <th class="p-3 text-left text-white">
                        <a class="bg-sky-900 overline" href="{{ route('employe.index3company') }}">派遣会社</a>
                      </th>
                      <th class="p-3 text-left text-white">名前</th>
                      <th class="p-3 text-left text-white">配属部署</th>
                      <th class="p-3 text-left text-white">
                        <a class="bg-sky-900 overline" href="{{ route('employe.index3section') }}">セクション</a>
                      </th>
                      <th class="p-3 text-left text-white">
                        <a class="bg-sky-900 overline" href="{{ route('employe.index3fday') }}">入社日</a>
                      </th>
                      <th class="p-3 text-left text-white">現契約開始日</th>
                      <th class="p-3 text-left text-white">
                        <a class="bg-sky-900 overline" href="{{ route('employe.index3eday') }}">現契約終了日</a>
                      </th>
                      <th class="p-3 text-left text-white">
                        <a class="bg-sky-900 overline" href="{{ route('employe.index3hcost') }}">派遣料
                      </th>
