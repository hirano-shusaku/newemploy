    ...
    <div class="my-6">
            <table class="text-left w-full border-collapse mt-8"> 
                    <tr class="bg-blue-700">
                        ...
                        {{--<th class="p-3 text-left text-white">
                          <a class="bg-sky-900 overline" href="{{ route('employe.indexcompany') }}">派遣会社</a>
                        </th>--}}
                        <th class="p-3 text-left text-white">名前</th>
                        <th class="p-3 text-left text-white">
                          <button type="button" class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 me-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">
                            @sortablelink('depart', '配属部署')
                          </button>
                        </th>
                        ...
                        {{-- <th class="p-3 text-left text-white">
                          <a class="bg-sky-900 overline" href="{{ route('employe.indexsection') }}">セクション</a>
                        </th> --}}
                        <th class="p-3 text-left text-white">
                          <button type="button" class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 me-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">
                        ...
                        {{-- <th class="p-3 text-left text-white">
                          <a class="bg-sky-900 overline" href="{{ route('employe.indexfday') }}">入社日</a>
                        </th> --}}
                        ...
                        {{-- <th class="p-3 text-left text-white">
                          <a class="bg-sky-900 overline" href="{{ route('employe.indexeday') }}">現契約終了日</a>
                        </th> --}}
                        <th class="p-3 text-left text-white">
                          <button type="button" class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 me-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">
                        ...
                        {{-- <th class="p-3 text-left text-white">
                          <a class="bg-sky-900 overline" href="{{ route('employe.indexhcost') }}">派遣料
                        </th> --}}
