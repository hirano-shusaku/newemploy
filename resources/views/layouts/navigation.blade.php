<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-6 sm:flex">
                    <x-nav-link :href="route('employe.create')" :active="request()->routeIs('employe.create')">
                        新規派遣登録
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('employe.getDelete')" :active="request()->routeIs('employe.getDelete')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('employe.create')" :active="request()->routeIs('employe.create')">
                新規派遣登録
